...
class ResultUtil
{
	public static Object[] readValues(QResultCursor cursor) throws SQLException
	{
	...
	public static Map<String,Object> readMap(QResultCursor cursor) throws SQLException
	{
